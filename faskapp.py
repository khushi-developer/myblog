...
# 'mysql://username:password@localhost/databasename'//pip install mysqlclient wheel file :unofficial binary file
...
def contact():
    ...
    if (request.method == 'POST'):
        ...
        #                   body=message + "\n" + phone
        #                  )
    return render_template('conme.html',params=params)
